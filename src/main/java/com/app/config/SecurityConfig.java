...
public class SecurityConfig {
	...
	public SecurityFilterChain authorizeRequests(HttpSecurity http) throws Exception
	{
		...
		.antMatchers("/products/view","/login","/signup","/swagger-ui/index.html","/users/role","/users/details","/users/interest","/users/{userId}/image","/service","/service/edit","/service/delete","/users/delete/{userId}","/users/edit").permitAll() // for incoming req ending with /products/view : no authentication n authorization needed
